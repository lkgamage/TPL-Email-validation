...
<title>AJC Email Validation Process</title>
<style type="text/css">
body {
                              ...
                              <td valign='top'><div  style="border: 0px; padding-top: 0px; position: relative;">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td><div>
                                            <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="font1">Luminate OPT-IN Report</span></p>
                                        </div></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                ...
                                <div  style="border: 0px; padding-top: 0px; position: relative;">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                    ...
                                    <tr>
                                      <td align='left'><div>
                                          <div  align='center'>
                                            <p >Opt-in report download failed.</p><br />
                                            <br />
                                            <p><?php echo $error; ?></p>
                                          </div>
                                        </div></td>
